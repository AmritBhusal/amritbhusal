        ...
        return (
            <div className="w-full min-h-screen bg-[#1b1712] flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-[#fbf1c7] mb-2">Project Not Found</h1>
                    <p className="text-[#a89984] mb-6">No project exists with ID &quot;{projectId}&quot;</p>
                    <button
            ...
            <div className="sticky top-0 z-10 bg-[#221d17] border-b border-[#3a3128] backdrop-blur-md bg-opacity-80">
                <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-[#a89984]">Editing: {project.name}</span>
                    </div>
                    <button
